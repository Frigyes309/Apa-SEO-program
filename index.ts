...
app.get("/link-redirection", async (req: any, res: any) => {
    ...
    const parameters = {
        ...
        redirect:
            req.query["redirectionTo"] != undefined
                ? req.query["redirectionTo"]
                : "",
        state: req.query["state"] != undefined ? req.query["state"] : 5,
        refererStatus:
            req.query["refererStatus"] != undefined
                ? Number(req.query["refererStatus"])
                : 4,
        isMainPage:
        ...
        fromPage:
            req.query["redirectionFrom"] != undefined
...
app.post(
    "/edit-one/:id/add-category/:newCategory",
...
app.post(
    "/edit-one/:id/save/:redirect/:state/:category",
    async (req: any, res: any) => {
...
app.get(
    "/nuke-all/yes-i-am-sure-i-want-to-nuke-everything",
    async (req: any, res: any) => {
